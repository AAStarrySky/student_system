...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <table class="table table-bordered table-striped table-hover">
                ...
                <c:forEach items="${requestScope.tags}" var="tag" varStatus="status">
                    <tr>
                        <td>${status.count}</td>
                        <td>${tag.name}</td>
                        <td>${tag.type}</td>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form  method="post" id="inputForm" class="form-inline">
                ...
                <button  id = "submitBtn" type="submit" class="btn btn-success">添加标签</button>
            </form>
        </div>
    </div>
    ...
    $(function(){
        ...
        $("#submitBtn").click(function(){
            ...
            if (!$("#name").val()) {
                ...
                $.post("${pageContext.request.contextPath}/tag/save",$("#inputForm").serialize(),function (res) {
                    console.log(res);
                    if(res.status){
                        alert(res.msg+",点击刷新页面");
                        location.href = "${pageContext.request.contextPath}/tag/findAll";
                    }else{
                        alert(res.msg);
                    }
                });
