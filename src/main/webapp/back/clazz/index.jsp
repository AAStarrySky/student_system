...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <table class="table table-striped table-hover table-bordered">
                ...
                <c:forEach items="${requestScope.clazzs}" var="clazz" varStatus="status">
                    <tr>
                        <td>${status.count}</td>
                        <td>${clazz.name}</td>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form id="inputForm" class="form-inline" method="post">
                ...
                <button type="submit" id= "submitBtn" class="btn btn-success">添加班级</button>
            </form>
        </div>
    </div>
    ...
    $(function(){
        ...
        $("#submitBtn").click(function(){
            ...
            if (!$("#name").val()) {
                ...
                $.post("${pageContext.request.contextPath}/clazz/save",$("#inputForm").serialize(),function (res) {
                    console.log(res);
                    if(res.status){
                        alert(res.msg+",点击刷新页面");
                        location.href = "${pageContext.request.contextPath}/clazz/findAll";
                    }else{
                        alert(res.msg);
                    }
                });
