    ...
    <div class="row">
        <div class="col-sm-12">
            <form id="inputForm" class="form-inline"  method="post">
                ...
                <button type="submit" id = "submitBtn" class="btn btn-success">添加</button>
            </form>
...
<script>
    $(function(){
        ...
        $("#submitBtn").click(function(){
            ...
            $.post("${pageContext.request.contextPath}/group/save",$("#inputForm").serialize(),function (res) {
                    console.log(res);
                    if(res.status){
                        alert(res.msg+",点击刷新页面");
                        location.href = "${pageContext.request.contextPath}/group/findAll";
                    }else{
                        alert(res.msg);
                    }
            });
